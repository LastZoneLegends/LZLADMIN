    ...
    <div>
      ...
      <div className="mt-4">
        ...
        <input
          ...
          onChange={(e) => setForm({ ...form, ZapApiKey: e.target.value })}
        />
      </div>

      <div className="mt-4">
        <label>Zap Secret</label>
        <input
          value={form.ZapSecret || ""}
          onChange={(e) => setForm({ ...form, ZapSecret: e.target.value })}
        />
      </div>
      ...
      <div className="mt-4">
        ...
        <input
          type="number"
          value={form.ZapMinDeposit || 10}
          onChange={(e) => setForm({ ...form, ZapMinDeposit: e.target.value })}
        />
      </div>
